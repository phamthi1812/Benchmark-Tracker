...
for file in os.listdir(home+"/research_project/benchmark-tracker/ai_benchmark/val/"):
    im = Image.open(os.path.join(home+"/research_project/benchmark-tracker/ai_benchmark/val/", file),'r')
    new_im = smart_resize(im,512)
    new_im.save(home+"/research_project/benchmark-tracker/ai_benchmark/output/%s.jpg"%n)
    n= n+1
