...
####### here I am trying to modify batch_size to make room for tracker work!!! pld btach size is (50,20,10,8,10,10,2,10,10,5,15,4,1,10,1,1,10,10,no training for last models!)
            ...
            Test(test_id=1, test_type="classification", model="MobileNet-V2", model_src="mobilenet_v2.meta",
                 ...
                 tests_inference=[SubTest(200, [224, 224, 3], [1001], 22, min_passes=5, max_duration=30, ref_time=75)],
            ...
            Test(test_id=2, test_type="classification", model="Inception-V3", model_src="inception_v3.meta",
                 use_src=False,
                 tests_training=[SubTest(80, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=275)],
                 tests_inference=[SubTest(80, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30, ref_time=85)],
            ...
            Test(test_id=3, test_type="classification", model="Inception-V4", model_src="inception_v4.meta",
                 use_src=False,
                 tests_training=[SubTest(40, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=290)],
                 tests_inference=[SubTest(40, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30, ref_time=68)],
            ...
            Test(test_id=4, test_type="classification", model="Inception-ResNet-V2", use_src=False,
                 ...
                 tests_training=[SubTest(32, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=330)],
                 tests_inference=[SubTest(40, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30, ref_time=90)],
            ...
            Test(test_id=5, test_type="classification", model="ResNet-V2-50", use_src=False,
                 ...
                 tests_inference=[SubTest(40, [346, 346, 3], [1001], 22, min_passes=5, max_duration=30, ref_time=48)],
            ...
            Test(test_id=6, test_type="classification", model="ResNet-V2-152", use_src=False,
                 ...
                 tests_training=[SubTest(40, [256, 256, 3], [1001], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=265)],
                 tests_inference=[SubTest(40, [256, 256, 3], [1001], 22, min_passes=5, max_duration=30, ref_time=60)],
            ...
            Test(test_id=7, test_type="classification", model="VGG-16", use_src=False,
                 ...
                 tests_training=[SubTest(8, [224, 224, 3], [1000], 22, min_passes=5, max_duration=30,
            ...
            Test(test_id=8, test_type="enhancement", model="SRCNN 9-5-5", model_src="srcnn.meta", use_src=False,
                 ...
                 tests_inference=[
                     SubTest(40, [512, 512, 3], [512, 512, 3], 22, min_passes=5, max_duration=30, ref_time=100),
                     SubTest(4, [1536, 1536, 3], [1536, 1536, 3], 22, min_passes=5, max_duration=30, ref_time=85)],
                 tests_micro=[
            ...
            Test(test_id=9, test_type="enhancement", model="VGG-19 Super-Res", model_src="vgg19.meta", use_src=False,
                 tests_training=[SubTest(40, [224, 224, 3], [224, 224, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=274)],
                 tests_inference=[
                     SubTest(40, [256, 256, 3], [512, 512, 3], 22, min_passes=5, max_duration=30, ref_time=114),
                     SubTest(4, [1024, 1024, 3], [1024, 1024, 3], 22, min_passes=5, max_duration=30, ref_time=162)],
                 tests_micro=[
            ...
            Test(test_id=10, test_type="enhancement", model="ResNet-SRGAN", model_src="srgan.meta", use_src=False,
                 tests_training=[SubTest(20, [512, 512, 3], [512, 512, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=170)],
                 tests_inference=[
                     SubTest(40, [512, 512, 3], [512, 512, 3], 22, min_passes=5, max_duration=30, ref_time=110),
                     SubTest(4, [1536, 1536, 3], [1536, 1536, 3], 22, min_passes=5, max_duration=30, ref_time=100)],
                 tests_micro=[
            ...
            Test(test_id=11, test_type="enhancement", model="ResNet-DPED", model_src="dped.meta", use_src=False,
                 tests_training=[SubTest(60, [128, 128, 3], [128, 128, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=200)],
                 tests_inference=[
                     SubTest(40, [256, 256, 3], [256, 256, 3], 22, min_passes=5, max_duration=30, ref_time=135),
                     SubTest(4, [1024, 1024, 3], [1024, 1024, 3], 22, min_passes=5, max_duration=30, ref_time=215)],
                 tests_micro=[
            ...
            Test(test_id=12, test_type="segmentation", model="U-Net", model_src="unet.meta", use_src=False,
                 tests_training=[SubTest(16, [256, 256, 3], [256, 256, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=240)],
                 tests_inference=[
                     SubTest(16, [512, 512, 3], [512, 512, 3], 22, min_passes=5, max_duration=30, ref_time=220),
                     SubTest(4, [1024, 1024, 3], [1024, 1024, 3], 22, min_passes=5, max_duration=30, ref_time=215)],
                 tests_micro=[
            ...
            Test(test_id=13, test_type="segmentation", model="Nvidia-SPADE", model_src="spade.meta", use_src=False,
                 tests_training=[SubTest(4, [128, 128, 3], [128, 128, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=200)],
                 tests_inference=[
                     SubTest(20, [128, 128, 3], [128, 128, 3], 22, min_passes=5, max_duration=30, ref_time=110)],
                 tests_micro=[
            ...
            Test(test_id=14, test_type="segmentation", model="ICNet", model_src="icnet.meta", use_src=False,
                 tests_training=[SubTest(40, [1024, 1536, 3], [1024, 1536, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=815)],
                 tests_inference=[
                     SubTest(20, [1024, 1536, 3], [1024, 1536, 3], 22, min_passes=5, max_duration=30, ref_time=270)],
                 tests_micro=[
            ...
            Test(test_id=15, test_type="segmentation", model="PSPNet", model_src="pspnet.meta", use_src=False,
                 tests_training=[SubTest(4, [512, 512, 3], [64, 64, 3], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=214)],
                 tests_inference=[
                     SubTest(20, [720, 720, 3], [90, 90, 3], 22, min_passes=5, max_duration=30, ref_time=472)],
            ...
            Test(test_id=16, test_type="segmentation", model="DeepLab", model_src="deeplab.meta", use_src=False,
                 tests_training=[SubTest(4, [384, 384, 3], [48, 48, 3], 22, min_passes=5, max_duration=30,
            ...
            Test(test_id=17, test_type="enhancement", model="Pixel-RNN", model_src="pixel_rnn.meta", use_src=True,
                 ...
                 tests_inference=[
                     SubTest(200, [64, 64, 3], [64, 64, 3], 22, min_passes=5, max_duration=30, ref_time=665)],
                 tests_micro=[]),

            Test(test_id=18, test_type="nlp", model="LSTM-Sentiment", model_src="lstm.meta", use_src=True,
                 tests_training=[SubTest(40, [1024, 300], [2], 22, min_passes=5, max_duration=30,
                                         loss_function="MSE", optimizer="Adam", learning_rate=1e-4, ref_time=728)],
                 tests_inference=[SubTest(400, [1024, 300], [2], 22, min_passes=5, max_duration=30, ref_time=547)],
                 tests_micro=[]),
